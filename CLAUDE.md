...
| Phase 14 | **Progress-Tracking aus Sonos** | `/api/now-playing` zeigt Mock-Timer. Sonos AVTransport `GetPositionInfo` pollen. Dann auch `isRealTransportModeRef`-Guard für progress/total aus Sonos befüllen. |
